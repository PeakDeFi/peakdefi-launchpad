...
contract AllocationStaking {
    ...
    // Total PEAK redistributed between people staking
    uint256 public totalPEAKRedistributed;
    ...
    function redistributePEAK(uint256 _pid, address _user, uint256 _amountToRedistribute) external
    onlyVerifiedSales
    {
    ...
    function burnFromUser(address user, uint256 _pid, uint256 amount) internal {
        ...
        totalPEAKRedistributed = totalPEAKRedistributed.add(amount);
